export default [
  ...
  },
  {
    ...
    name: 'BetaProfile',
    full_name: 'bchiang7/BetaProfile',
    private: false,
    owner: {
      login: 'bchiang7',
      id: 6599979,
    ...
    html_url: 'https://github.com/bchiang7/BetaProfile',
    description: 'A nicer look at your GitHub Profile! With charts!',
    fork: false,
    url: 'https://api.github.com/repos/bchiang7/BetaProfile',
    forks_url: 'https://api.github.com/repos/bchiang7/BetaProfile/forks',
    keys_url: 'https://api.github.com/repos/bchiang7/BetaProfile/keys{/key_id}',
    collaborators_url:
      'https://api.github.com/repos/bchiang7/BetaProfile/collaborators{/collaborator}',
    teams_url: 'https://api.github.com/repos/bchiang7/BetaProfile/teams',
    hooks_url: 'https://api.github.com/repos/bchiang7/BetaProfile/hooks',
    issue_events_url: 'https://api.github.com/repos/bchiang7/BetaProfile/issues/events{/number}',
    events_url: 'https://api.github.com/repos/bchiang7/BetaProfile/events',
    assignees_url: 'https://api.github.com/repos/bchiang7/BetaProfile/assignees{/user}',
    branches_url: 'https://api.github.com/repos/bchiang7/BetaProfile/branches{/branch}',
    tags_url: 'https://api.github.com/repos/bchiang7/BetaProfile/tags',
    blobs_url: 'https://api.github.com/repos/bchiang7/BetaProfile/git/blobs{/sha}',
    git_tags_url: 'https://api.github.com/repos/bchiang7/BetaProfile/git/tags{/sha}',
    git_refs_url: 'https://api.github.com/repos/bchiang7/BetaProfile/git/refs{/sha}',
    trees_url: 'https://api.github.com/repos/bchiang7/BetaProfile/git/trees{/sha}',
    statuses_url: 'https://api.github.com/repos/bchiang7/BetaProfile/statuses/{sha}',
    languages_url: 'https://api.github.com/repos/bchiang7/BetaProfile/languages',
    stargazers_url: 'https://api.github.com/repos/bchiang7/BetaProfile/stargazers',
    contributors_url: 'https://api.github.com/repos/bchiang7/BetaProfile/contributors',
    subscribers_url: 'https://api.github.com/repos/bchiang7/BetaProfile/subscribers',
    subscription_url: 'https://api.github.com/repos/bchiang7/BetaProfile/subscription',
    commits_url: 'https://api.github.com/repos/bchiang7/BetaProfile/commits{/sha}',
    git_commits_url: 'https://api.github.com/repos/bchiang7/BetaProfile/git/commits{/sha}',
    comments_url: 'https://api.github.com/repos/bchiang7/BetaProfile/comments{/number}',
    issue_comment_url: 'https://api.github.com/repos/bchiang7/BetaProfile/issues/comments{/number}',
    contents_url: 'https://api.github.com/repos/bchiang7/BetaProfile/contents/{+path}',
    compare_url: 'https://api.github.com/repos/bchiang7/BetaProfile/compare/{base}...{head}',
    merges_url: 'https://api.github.com/repos/bchiang7/BetaProfile/merges',
    archive_url: 'https://api.github.com/repos/bchiang7/BetaProfile/{archive_format}{/ref}',
    downloads_url: 'https://api.github.com/repos/bchiang7/BetaProfile/downloads',
    issues_url: 'https://api.github.com/repos/bchiang7/BetaProfile/issues{/number}',
    pulls_url: 'https://api.github.com/repos/bchiang7/BetaProfile/pulls{/number}',
    milestones_url: 'https://api.github.com/repos/bchiang7/BetaProfile/milestones{/number}',
    notifications_url:
      'https://api.github.com/repos/bchiang7/BetaProfile/notifications{?since,all,participating}',
    labels_url: 'https://api.github.com/repos/bchiang7/BetaProfile/labels{/name}',
    releases_url: 'https://api.github.com/repos/bchiang7/BetaProfile/releases{/id}',
    deployments_url: 'https://api.github.com/repos/bchiang7/BetaProfile/deployments',
    created_at: '2019-06-04T23:58:30Z',
    updated_at: '2019-06-15T21:12:31Z',
    pushed_at: '2019-06-15T21:12:30Z',
    git_url: 'git://github.com/bchiang7/BetaProfile.git',
